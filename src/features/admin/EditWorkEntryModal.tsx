...
export default function EditWorkEntryModal({ entry, onClose, onSaved }: EditWorkEntryModalProps) {
  ...
  return (
    <div style={overlayStyle} onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div style={modalStyle} role="dialog" aria-modal="true" aria-labelledby="edit-modal-title">
        {/* Header */}
        <div style={modalHeaderStyle}>
          <div>
            <h2 id="edit-modal-title" style={modalTitleStyle}>Edit Work Entry</h2>
            <p style={modalSubtitleStyle}>{entry.employeeName} · {formatDate(entry.workDate)}</p>
          </div>
